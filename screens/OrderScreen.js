  ...
  const handleDataProduct = () => {
    ...
    const updatedListProducts = Object.values(groupedProducts).map((group) => {
      ...
      return {
        ...
        totalByShop: total + transportationCost,
        idShop: idShop
      }; 
    });
  ...
  return (
    <>
      <ScrollView style={{ flex: 1, backgroundColor: "white" }}>
        ...
        <View style={{ borderBottomWidth: 2, borderColor:'green' }} key={index}>
          ...
          >
              ...
              <View style={{ padding: 10}}>
                  <Text style={{textAlign: 'right'}}>{group.totalByShop - transportationCost} đ</Text>
                  <Text style={{textAlign: 'right'}}>0 đ</Text>
                  <Text style={{textAlign: 'right'}}>{transportationCost} đ</Text>
                  <Text style={{textAlign: 'right'}}>- 0 đ</Text>
                  <Text  style={{ fontSize:18, color:'red',textAlign: 'right'}}>{group.totalByShop} đ</Text>
              </View>
          </View>
        </View>
        )} 
