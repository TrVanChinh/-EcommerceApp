...
import {
  ...
  const ResetAddressScreen = ({navigation}) => {
    const { user } = useUser();
    ...
    return (
      <View>
        ...
        <Pressable
          ...
          onPress={()=>{
            lableProvinces === null || lableDistrict === null || lableWard === null ? console.log("Chọn đủ thông tin địa chỉ") : navigation.navigate('UpdateAddress', {
              lableProvinces,
              lableDistrict,
              lableWard,
            });
  ...
  export default ResetAddressScreen
